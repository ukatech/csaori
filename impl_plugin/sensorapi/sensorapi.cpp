...
#define DEFINE_SENSOR_TABLE(s) {SENSOR_TYPE_ ## s,L ## #s},
	...
	static const struct { const SENSOR_TYPE_ID id; const wchar_t * const str; } sensor_type_table[] = {
		...
		DEFINE_SENSOR_TABLE(AGGREGATED_QUADRANT_ORIENTATION)
		DEFINE_SENSOR_TABLE(AGGREGATED_DEVICE_ORIENTATION)
		DEFINE_SENSOR_TABLE(AGGREGATED_SIMPLE_DEVICE_ORIENTATION)
		...
		DEFINE_SENSOR_TABLE(BOOLEAN_SWITCH_ARRAY)
		...
		DEFINE_SENSOR_TABLE(CUSTOM)
		DEFINE_SENSOR_TABLE(UNKNOWN)
	};
...
#define DEFINE_DATA_TYPE_TABLE(s) {SENSOR_DATA_TYPE_ ## s,L ## #s},
	...
	static const struct { const PROPERTYKEY id; const wchar_t * const str; } data_type_table[] = {
		...
		DEFINE_DATA_TYPE_TABLE(LOCATION_SOURCE)
		DEFINE_DATA_TYPE_TABLE(SATELLITES_USED_PRNS_AND_CONSTELLATIONS)
		...
		DEFINE_DATA_TYPE_TABLE(ANGULAR_VELOCITY_X_DEGREES_PER_SECOND)
		DEFINE_DATA_TYPE_TABLE(ANGULAR_VELOCITY_Y_DEGREES_PER_SECOND)
		DEFINE_DATA_TYPE_TABLE(ANGULAR_VELOCITY_Z_DEGREES_PER_SECOND)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_HEADING_COMPENSATED_MAGNETIC_NORTH_DEGREES)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_HEADING_COMPENSATED_TRUE_NORTH_DEGREES)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_HEADING_MAGNETIC_NORTH_DEGREES)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_HEADING_TRUE_NORTH_DEGREES)
		DEFINE_DATA_TYPE_TABLE(QUADRANT_ANGLE_DEGREES)
		DEFINE_DATA_TYPE_TABLE(ROTATION_MATRIX)
		DEFINE_DATA_TYPE_TABLE(QUATERNION)
		DEFINE_DATA_TYPE_TABLE(SIMPLE_DEVICE_ORIENTATION)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_FIELD_STRENGTH_X_MILLIGAUSS)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_FIELD_STRENGTH_Y_MILLIGAUSS)
		DEFINE_DATA_TYPE_TABLE(MAGNETIC_FIELD_STRENGTH_Z_MILLIGAUSS)
		DEFINE_DATA_TYPE_TABLE(MAGNETOMETER_ACCURACY)
		...
		DEFINE_DATA_TYPE_TABLE(BOOLEAN_SWITCH_ARRAY_STATES)
		...
		DEFINE_DATA_TYPE_TABLE(ELECTRICAL_PERCENT_OF_RANGE)
		DEFINE_DATA_TYPE_TABLE(ELECTRICAL_FREQUENCY_HERTZ)
		
		DEFINE_DATA_TYPE_TABLE(CUSTOM_USAGE)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_BOOLEAN_ARRAY)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE1)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE2)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE3)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE4)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE5)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE6)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE7)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE8)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE9)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE10)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE11)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE12)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE13)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE14)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE15)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE16)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE17)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE18)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE19)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE20)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE21)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE22)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE23)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE24)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE25)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE26)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE27)
		DEFINE_DATA_TYPE_TABLE(CUSTOM_VALUE28)
	};
