...
#define SAORI_VERSIONSTRING_10_A	"SAORI/1.0"
...
typedef enum {SAORIRESULT_FORCE_OK=0,SAORIRESULT_OK=200,SAORIRESULT_NO_CONTENT=204,SAORIRESULT_BAD_REQUEST=400,SAORIRESULT_INTERNAL_SERVER_ERROR=500} SAORIRESULT;
